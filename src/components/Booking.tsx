...
export default function Booking() {
  ...
  return (
    <section
      id="book"
      ref={sectionRef}
      className="py-24 sm:py-40 px-6 sm:px-8 md:px-16 relative overflow-hidden"
    >
      <div className="booking-inner relative z-10 max-w-5xl mx-auto text-center">
        ...
        <p className="font-body text-sm text-white/50 max-w-xl mx-auto mb-12 sm:mb-16">
          Pick a time that works for you — a Google Meet link lands in your
          inbox the moment you book.
        </p>
